...
// constant, not a settings-UI knob: a user-tunable depth will defeat the
...
// A thread at depth d can spawn a child iff d < MAX_SUBAGENT_DEPTH. Root user
...
// (the excess queues), so the live value is a renderer pref seeded here.

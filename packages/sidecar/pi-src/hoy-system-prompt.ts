...
// - The "Tool guidelines" entries are pi 0.80.2's promptGuidelines verbatim
...
- The pi source and docs live at https://github.com/earendil-works/pi, version v0.80.2, under packages/coding-agent/
- Fetch files with curl from the raw mirror, for example: curl -s https://raw.githubusercontent.com/earendil-works/pi/v0.80.2/packages/coding-agent/docs/extensions.md

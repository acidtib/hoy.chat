...
export const PROPOSED_PLAN_FORMAT = [
  ...
  "",
  "## Summary",
  "<one or two sentences: what this builds and the approach>",
  "",
  "## Key changes",
...
export const PLAN_MODE_PROMPT = [
  ...
  "   - Propose an approach that follows the codebase's existing patterns",
  "   - Weigh the real tradeoffs and name the one you chose",

...
// - The "Tool guidelines" entries are pi 0.80.3's promptGuidelines verbatim
...
- The pi source and docs live at https://github.com/earendil-works/pi, version v0.80.3, under packages/coding-agent/
- Fetch files with curl from the raw mirror, for example: curl -s https://raw.githubusercontent.com/earendil-works/pi/v0.80.3/packages/coding-agent/docs/extensions.md
...
export const PLAN_MODE_PROMPT = [
  ...
  "This is a planning turn. You are STRICTLY PROHIBITED from:",
  ...
  "## Plan File Output",
  "",
  "When to write a plan file vs present inline:",
  "- Write a plan file when the plan has 3+ distinct implementation steps, spans multiple files, or is complex enough to warrant review before execution.",
  "- Present inline when the plan is a single straightforward change or the user explicitly asks for an inline plan.",
  "",
  "If writing a plan file:",
  "- Save to docs/plans/ in the project root. The directory is auto-created if it does not exist.",
  "- Naming: for ticket-based plans use HOY-NNN-short-description.md (e.g. HOY-212-plan-mode-write.md). For non-ticket plans use YYYY-MM-DD-short-description.md.",
  "- write is ONLY permitted for new plan files in docs/plans/. Do not write implementation code, config, or any other file.",
  "",
  "## Required Output",
  "",
  ...
  "",
  "REMEMBER: You can ONLY explore and plan. You CANNOT and MUST NOT edit or modify existing files. Write is ONLY for plan markdown files in docs/plans/. Present your plan and stop; the user will switch modes when ready to implement.",
].join("\n");
